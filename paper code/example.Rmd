...
# Some packages not loaded. Those that are not loaded, but which you will need to run the code, are:
# msa from Bioconductor
...
cgr_distance(beta_cg, frac = 1) |> ape::bionj() |> ape::root("gallus") |> plot()
cgr_distance(beta_cg, frac = 1) |> ape::bionj() |> ape::root("gallus") |> plot()
cgr_distance(beta_cg, frac = 1/15) |> ape::bionj() |> ape::root("gallus") |> plot()

cgr_distance(nadh_cg, frac = 1) |> hm()
cgr_distance(nadh_cg, frac = 1/15) |> hm()
cgr_distance(nadh_cg, frac = 1) |> ape::bionj() |> plot()
cgr_distance(nadh_cg, frac = 1/15) |> ape::bionj() |> plot()
