...
plot_grid(
  clustal_omega(beta_seq) |> bionj() |> root("gallus") |> ggtree() + geom_tiplab(),
  cgr_distance2(beta_cg, frac = 1/15, normalize = T) |> (\(x) x / max(x))() |> bionj() |> root("gallus") |> ggtree() + geom_tiplab(),
  beta_tanimoto |> (\(x) 1 - x)() |> bionj() |> ape::root("gallus") |> ggtree() + geom_tiplab(),
  clustal_omega(nadh) |> bionj() |> root("Saimiri sciureus") |> ggtree() + geom_tiplab(),
  cgr_distance2(nadh_cg, frac = 1/15) |> bionj() |> root("Saimiri sciureus") |> ggtree() + geom_tiplab(),
  nadh_tanimoto |> (\(x) 1 - x)() |> bionj() |> root("Saimiri sciureus") |> ggtree() + geom_tiplab(),
  clustal_omega(sim_fas) |> bionj() |> ggtree() + geom_tiplab(),
  cgr_distance2(sim_cg, frac = 1/15) |> bionj() |> ggtree() + geom_tiplab(),
  sim_tanimoto |> (\(x) 1 - x)() |> (\(x) x / max(x))() |> bionj() |> ggtree() + geom_tiplab(),
  align = "hv", axis = "lr", ncol = 3
)
